...
```bash
git remote add encore encore://leap-app-prp2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/leap-app-prp2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/leap-app-prp2/settings/integrations/github)
